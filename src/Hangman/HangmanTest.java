...
class HangmanTest {
	...
	void test4() {
		...
		assertEquals(false, hangman1.equals(hangman2),
				"Test Case 4: testing if one Hangman obj and a Player obk are not equal");
	}
	...
	void test5() {
		...
		assertEquals(true, hangman1.checkGuess(guess),
				"Test Case 5: testing if check guess returns true for correct guess");
	}
	...
	void test6() {
		...
		assertEquals(false, hangman1.checkGuess(guess),
				"Test Case 6: testing if check guess returns false for a incorrect guess");
	}
	...
	void test7() {
		...
		assertEquals("_ o o _ _ _ _ _ ", hangman1.toString(),
				"Test Case 7: testing if toString returns correct output");
	}
	...
	void test8() {
		...
		assertEquals(false, hangman2.recieveHint(),
				"Test Case 8: testing if hint returns false since word is complete");
		...
		assertEquals(true, hangman3.recieveHint(),
				"Test Case 8: testing if hint returns false since word is not complete");
	...
	void test9() {
		...
		assertEquals(false, hangman1.isGameWon(),
				"Test Case 9: testing if isGameWon would return false if word isn't complete");
		...
		assertEquals(true, hangman2.isGameWon(),
				"Test Case 9: testing if isGameWon would return false if word is complete");
	}
